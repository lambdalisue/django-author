...
def with_author(cls):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('author'), related_name='%s_create' % verbose_name_plural.lower(), null=True, blank=True, on_delete=models.SET_NULL)
    updated_by = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('last updated by'), related_name='%s_update' % verbose_name_plural.lower(), null=True, blank=True, on_delete=models.SET_NULL)
